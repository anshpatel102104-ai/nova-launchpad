type NovaAvatarMood = "active" | "thinking" | "alert" | "idle";
    ...
    >
      ...
      <circle
        ...
        style={{
          ...
          animation: "nova-outer-spin 12s linear infinite",
        }}
      />
      ...
      <circle
        ...
        style={{
          transformOrigin: `${cx}px ${cx}px`,
          animation: "nova-mid-pulse 3s ease-in-out infinite",
        }}
      />
      ...
      <circle
        ...
        style={{
          ...
          animation: "nova-blink 4s ease-in-out infinite",
        }}
      />
      <circle
        cx={cx + eyeOffX}
