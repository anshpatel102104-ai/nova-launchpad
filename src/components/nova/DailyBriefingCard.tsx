// Daily briefing — Nova's overnight check, in the app instead of only Slack.
// Shows the latest org_briefings row (written by the nova-pulse worker each
// morning): what Nova found, the one recommended action, and a link to the
