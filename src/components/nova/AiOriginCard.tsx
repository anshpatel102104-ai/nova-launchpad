/**
 * AiOriginCard — the one shared "Nova is speaking" surface.
 *
 * Any AI-generated fragment across the app (suggested reply, next-best-action
 * nudge, mentor insight, a casefile's "Nova's Take") renders through this
...
export function AiOriginCard({
  ...
  /** Eyebrow text — who/what is speaking (e.g. "Nova", "Nova's Take", "Suggested reply"). */
  label?: string;
