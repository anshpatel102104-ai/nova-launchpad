...
export const GUEST_LEADS = [
  ...
  },
  {
    ...
    user_id: GUEST_USER.id,
    name: "Diego Romero",
    email: "diego@helio.studio",
    phone: "+34 91 555 7820",
    source: "Cold email",
    stage: "New",
    value: 0,
    notes: null,
...
export const GUEST_ASSETS = [
  {
    ...
    organization_id: GUEST_ORG_ID,
    user_id: GUEST_USER.id,
    category: "generate-pitch",
    kind: "pitch-generator",
    title: "Northwind Labs — Series A Pitch",
    content: { sections: [] },
    metadata: {},
    storage_path: null,
    tool_run_id: null,
  ...
  },
  {
    ...
    organization_id: GUEST_ORG_ID,
    user_id: GUEST_USER.id,
    category: "generate-offer",
    kind: "offer",
    title: "Founder Coaching — $2k/mo Offer",
    content: { hook: "" },
    metadata: {},
    storage_path: null,
    tool_run_id: null,
  ...
  },
  {
    ...
    organization_id: GUEST_ORG_ID,
    user_id: GUEST_USER.id,
    category: "generate-followup-sequence",
    kind: "followup",
...
export const GUEST_TOOL_RUNS = [
  ...
  },
  {
    ...
    organization_id: GUEST_ORG_ID,
    user_id: GUEST_USER.id,
    tool_key: "generate-followup-sequence",
    status: "succeeded" as const,
    input: {},
    output: {},
    error: null,
