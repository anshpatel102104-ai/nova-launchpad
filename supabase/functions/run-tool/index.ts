...
const TOOLS: Record<string, ToolConfig> = {
  "validate-idea": {
    ...
    schema: {
      ...
      parameters: {
        ...
        required: ["viabilityScore", "marketSize", "problemSeverity", "competitionLevel", "strengths", "weaknesses", "recommendation"],
      },
    },
  ...
  "generate-pitch": {
    ...
    schema: {
      ...
      parameters: {
        ...
        required: ["headline", "problem", "solution", "marketOpportunity", "traction", "ask", "elevatorPitch"],
      },
    },
    assetCategory: "pitch",
    ...
    schema: {
      ...
      parameters: {
        ...
        properties: {
          ...
          messagingFramework: { type: "object", properties: { hook: { type: "string" }, valueProps: { type: "array", items: { type: "string" } }, cta: { type: "string" } }, required: ["hook", "valueProps", "cta"] },
  ...
  "generate-offer": {
    ...
    schema: {
      ...
      parameters: {
        ...
        required: ["offerName", "coreDeliverable", "bonuses", "guarantee", "price", "urgencyMechanic", "headline"],
      },
    },
    assetCategory: "offer",
  ...
  "kill-my-idea": {
    ...
    schema: {
      ...
      parameters: {
        ...
        required: ["fatalFlaws", "marketRisks", "executionRisks", "wrongAssumptions", "killerQuestion", "survivalPath"],
      },
    },
    assetCategory: "validation",
  ...
  "idea-vs-idea": {
      ...
      parameters: {
        ...
        properties: {
          ...
          comparison: {
            type: "object",
            properties: {
              marketPotential: { type: "object", properties: { a: { type: "string" }, b: { type: "string" } }, required: ["a", "b"] },
              executionDifficulty: { type: "object", properties: { a: { type: "string" }, b: { type: "string" } }, required: ["a", "b"] },
              monetisationSpeed: { type: "object", properties: { a: { type: "string" }, b: { type: "string" } }, required: ["a", "b"] },
              competitiveMoat: { type: "object", properties: { a: { type: "string" }, b: { type: "string" } }, required: ["a", "b"] },
            },
            required: ["marketPotential", "executionDifficulty", "monetisationSpeed", "competitiveMoat"],
          },
        },
    ...
    assetCategory: "validation",
    assetTitle: (i) => `Idea vs Idea: ${String(i.ideaA).slice(0, 30)} vs ${String(i.ideaB).slice(0, 30)}`,
  },
    ...
    schema: {
      ...
      parameters: {
        ...
        properties: {
          ...
          features: { type: "array", items: { type: "object", properties: { title: { type: "string" }, description: { type: "string" } }, required: ["title", "description"] } },
        ...
        required: ["headline", "subheadline", "heroCopy", "features", "socialProofSection", "faq", "ctaCopy"],
      },
    },
    assetCategory: "copy",
    ...
    schema: {
      ...
      parameters: {
        ...
        properties: {
          ...
          weekByWeekPlan: { type: "array", items: { type: "object", properties: { week: { type: "number" }, actions: { type: "array", items: { type: "string" } } }, required: ["week", "actions"] } },
          outreachTemplates: { type: "array", items: { type: "object", properties: { channel: { type: "string" }, template: { type: "string" } }, required: ["channel", "template"] } },
  ...
  "business-plan": {
    ...
    schema: {
      ...
      parameters: {
        ...
        required: ["executiveSummary", "problemStatement", "solution", "marketAnalysis", "businessModel", "gtmStrategy", "teamSection", "financialProjections", "milestones"],
      },
    },
    assetCategory: "plan",
  ...
  "pricing-strategy": {
    ...
    schema: {
      ...
      parameters: {
        ...
        required: ["recommendedModel", "tiers", "psychologicalTactics", "expansionLevers", "rationale"],
      },
    },
      ...
      parameters: {
        ...
        properties: {
          ...
          scenarios: {
            type: "object",
            properties: {
              conservative: { type: "array", items: { type: "object", properties: { month: { type: "number" }, mrr: { type: "number" }, arr: { type: "number" } }, required: ["month", "mrr", "arr"] } },
              base: { type: "array", items: { type: "object", properties: { month: { type: "number" }, mrr: { type: "number" }, arr: { type: "number" } }, required: ["month", "mrr", "arr"] } },
              aggressive: { type: "array", items: { type: "object", properties: { month: { type: "number" }, mrr: { type: "number" }, arr: { type: "number" } }, required: ["month", "mrr", "arr"] } },
            },
  ...
  "lead-outreach-system": {
    ...
    schema: {
      ...
      parameters: {
        ...
        required: ["icpDefinition", "channelStrategy", "emailSequence", "linkedinMessages", "followUpCadence"],
      },
    },
    assetCategory: "sales",
